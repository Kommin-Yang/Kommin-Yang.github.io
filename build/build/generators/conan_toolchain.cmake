...
set(CMAKE_VS_DEBUGGER_ENVIRONMENT "PATH=$<$<CONFIG:Release>:C:/Users/k.yang/.conan2/p/b/sfml29dd4f24f5469/p/bin>;%PATH%")
...
list(PREPEND CMAKE_LIBRARY_PATH "C:/Users/k.yang/.conan2/p/b/sfml29dd4f24f5469/p/lib" "lib" "lib" "lib" "lib" "lib" "lib" "lib" "lib" "lib" "lib" "lib")
list(PREPEND CMAKE_INCLUDE_PATH "C:/Users/k.yang/.conan2/p/b/sfml29dd4f24f5469/p/include" "include" "include" "include" "include" "include" "include" "include" "include" "include" "include" "include")
set(CONAN_RUNTIME_LIB_DIRS "$<$<CONFIG:Release>:C:/Users/k.yang/.conan2/p/b/sfml29dd4f24f5469/p/bin>" "$<$<CONFIG:Release>:bin>" "$<$<CONFIG:Release>:bin>" "$<$<CONFIG:Release>:bin>" "$<$<CONFIG:Release>:bin>" "$<$<CONFIG:Release>:bin>" "$<$<CONFIG:Release>:bin>" "$<$<CONFIG:Release>:bin>" "$<$<CONFIG:Release>:bin>" "$<$<CONFIG:Release>:bin>" "$<$<CONFIG:Release>:bin>" "$<$<CONFIG:Release>:bin>" )
