...
if(DEFINED sfml_FIND_DEPENDENCY_NAMES)
  list(APPEND sfml_FIND_DEPENDENCY_NAMES opengl_system)
  list(REMOVE_DUPLICATES sfml_FIND_DEPENDENCY_NAMES)
else()
  set(sfml_FIND_DEPENDENCY_NAMES opengl_system)
endif()
set(opengl_system_FIND_MODE "NO_MODULE")

########### VARIABLES #######################################################################
#############################################################################################
set(sfml_PACKAGE_FOLDER_RELEASE "C:/Users/k.yang/.conan2/p/b/sfml29dd4f24f5469/p")
...
set(sfml_sfml-main_BIN_DIRS_RELEASE "${sfml_PACKAGE_FOLDER_RELEASE}/bin")
set(sfml_sfml-main_LIBRARY_TYPE_RELEASE SHARED)
set(sfml_sfml-main_IS_HOST_WINDOWS_RELEASE 1)
set(sfml_sfml-main_RES_DIRS_RELEASE )
set(sfml_sfml-main_DEFINITIONS_RELEASE )
set(sfml_sfml-main_OBJECTS_RELEASE )
set(sfml_sfml-main_COMPILE_DEFINITIONS_RELEASE )
